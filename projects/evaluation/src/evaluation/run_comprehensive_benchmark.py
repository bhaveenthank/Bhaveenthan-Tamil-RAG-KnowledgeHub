...
def write_outputs(
    ...
    *,
    ...
    write_evaluation_manifest(
        evaluation_type="comprehensive_benchmark",
        producer="evaluation.run_comprehensive_benchmark",
        record_count=int(payload["question_count"]),
        outputs={
            "results": output,
        ...
        modes=["retrieval", "query_expansion", "occurrence_search", "analytics"],
        metrics=summary,
        warnings=[
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_outputs(
        ...
        source_artifacts=[str(args.taxonomy)],
    )
